		...
		<div class="main-content">
			...
			<div class="page-title">
				...
				<div class="title-env">
					...
					<p class="description">Contain about category</p>
				</div>
								...
								<table cellspacing="0" class="table table-small-font table-bordered table-striped">
									<thead>
										<tr>
											...
											<th data-priority="1" colspan="2">Action</th>
										</tr>
									</thead>
									<tbody>
										<?php
										...
										<tr>
											<th><?= $no++;?></th>
											<td><?= $value->id_kat;?></td>
											<td><?= $value->nama_kat;?></td>
											<td>
												<?= form_open('page/editCat');?>
												<input type="hidden"  name="id" value="<?= $value->id_kat;?>">
												<button class="btn btn-info btn-single">Update</button>
												<?= form_close();?>
											</td>
											<td>
												<?= form_open('foodspot/delCat');?>
												<input type="hidden"  name="id" value="<?= $value->id_kat;?>">
