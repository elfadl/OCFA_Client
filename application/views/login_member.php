	...
	<div class="login-container">
		...
		<div class="row">
			...
			<div class="col-sm-6">
				...
				<form method="post" role="form" class="login-form fade-in-effect" action="<?= base_url();?>index.php/foodspot/loginMember">
					...
					<div class="login-header">
						...
						<p>Dear user, log in to access the member area!</p>
					</div>
					...
					<div class="login-footer">
						<a href="<?= base_url();?>index.php/page/fsRegist"<label class="control-label">Do not have an account? Register here!</label>
